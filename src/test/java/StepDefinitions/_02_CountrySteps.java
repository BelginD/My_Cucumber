...
public class _02_CountrySteps {
    ...
    public void createANewCountry() {
        ...
        dc.sendKeysMethod(dc.getFormNameInput(), "XYZ1");
        dc.sendKeysMethod(dc.getFormCodeInput(), "xyz1");
    ...
    public void deleteCountry() {
        dc.sendKeysMethod(dc.getNameSearch(), "XYZ1");
        dc.sendKeysMethod(dc.getCodeSearch(), "xyz1");
...
//        dc.clickMethod(dc.getSearchBtn());
//        dc.wait.until(ExpectedConditions.numberOfElementsToBeLessThan(By.cssSelector("ms-delete-button[class='ng-star-inserted']"), 10));
//        dc.clickMethod(dc.getRow());
//        dc.clear(dc.getFormCodeInput());
//        dc.sendKeysMethod(dc.getFormCodeInput(), "xyzNew");
//        dc.clickMethod(dc.getSaveButton());
//
//    }
}
