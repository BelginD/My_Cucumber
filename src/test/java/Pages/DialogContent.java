...
public class DialogContent extends MyMethods {
    ...
    private WebElement prioritySearch;
    ...
    private WebElement descriptionAndNoteInputIFrame;
    ...
    public WebElement getPrioritySearch() {
    ...
    public WebElement getDescriptionAndNoteInputIFrame() {
        return descriptionAndNoteInputIFrame;
    }
